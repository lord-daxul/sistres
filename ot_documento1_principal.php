...
if ($borrar_pagina == 0) { ?>
  ...
  <body>
    ...
    <form action="ot_documento1_principal.php" method="POST" name="form1" id="form1" enctype="multipart/form-data">
...
-->
          ...
          <tr>
            ...
            <td width="79%" align="left"><input name="rutdocot" type="text" class="" id="rutdocot" value="<?php if ($fila['rutdocot'] == 0) {
                                                                                                          } else {
                                                                                                            echo formato_rut($fila['rutdocot']);
                                                                                                          } ?>" size="10" <?php echo $sw_desact_rut ?>></td>
          </tr>
          ...
          <tr>
            ...
            <td width="81%" align="left"><input name="Crear" type="submit" value="Ingresar" />
          </tr>
        </tbody>
      </table>
