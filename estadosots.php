...
<table width="500" align="center" class="tabla" id="tabla">
	...
	<tbody>
		...
		<tr>
		  <td align="left"><?php  echo $row['nombreestadoots']; ?></td>
		  <td align="center">
          <a href="estadoot.php?id=<?php  echo $row['idestadoots']; ?>&accion=editar" rel="gb_page_fs[]">Editar</a> &nbsp;
          <!--
<a href="javascript:;" onclick="confirmar('estadoot_principal.php?id=<?php  echo $row['idestadoots']; ?>&accion=eliminar&url=<?php  echo $_SERVER['REQUEST_URI'] ?>'); return false;">Eliminar</a>
-->
          </td>
		</tr>
		<?php  } ?>
