...
<table width="456" align="center" class="tabla" id="tabla">
	...
	<tbody>
		...
		<tr>
		  <td align="left"><? echo $row['titulo_categoriasobl']; ?></td>
		  <td align="left"><? echo $row['ncategoriasobl']; ?></td>
		  <td align="center">
          <a href="categoriasobl.php?id=<? echo $row['idcategoriasobl']; ?>&accion=editar" rel="gb_page_fs[]">Editar</a> &nbsp;
          <a href="javascript:;" onclick="confirmar('categoriasobl_principal.php?id=<? echo $row['idcategoriasobl']; ?>&accion=eliminar&url=<? echo $_SERVER['REQUEST_URI'] ?>'); return false;">Eliminar</a>
          </td>
		</tr>
		<? } ?>
